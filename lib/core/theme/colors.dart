...
class AppColors {
  static const Color primaryColor = Color(0xFFD191A3);
  static const Color labelColor = Color(0xFF696969);
  static const Color borderColor=Color(0xffDADADA);
  static const Color primaryColor2 = Colors.green;
  static const Color backgroundColor = Colors.white;
  static const Color textBlackColor = Color(0xff111111);
  static const Color textGreyColor = Color.fromARGB(255, 128, 128, 128);
